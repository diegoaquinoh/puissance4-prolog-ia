...
% ============================================================================
%
% An enhanced Minimax AI for Connect 4 with:
%   1. Immediate win/block detection (before minimax search)
%   2. Gravity-aware window scoring (playable vs floating threats)
%   3. Positional heuristic (center control preference)
%
% The AI beats the basic minimax by properly evaluating threat reachability.
%
% ============================================================================
...
%   3. MINIMAX: Search for best move with depth 4
...
% Recursive case: Explore all moves and pick best
...
% Column evaluation order (natural order - heuristic handles differentiation)
column_order([0, 1, 2, 3, 4, 5, 6]).

% best_max(+Moves, -BestScore, -BestCol)
%   Finds the move with maximum score (for Red)
best_max([S-C], S, C).
...
% best_min(+Moves, -BestScore, -BestCol)
%   Finds the move with minimum score (for Yellow)
best_min([S-C], S, C).
